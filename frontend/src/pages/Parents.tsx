...
export const Parents = () => {
  ...
  useEffect(() => {
    dispatch(fetchUsersByRole("parent"));
  }, [dispatch]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editing)
        await dispatch(
          updateUser({ id: editing._id, user: { ...form, role: "parent" } }),
        ).unwrap();
      else
        await dispatch(
          createUser({ role: "parent", user: { ...form, role: "parent" } }),
        ).unwrap();
      await dispatch(fetchUsersByRole("parent"));
      closeModal();
    } catch (err: any) {
  ...
  return (
    <div>
      <NavHeader name="Users - Parents" pageCreate="Crear" />
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">
                  {editing ? "Editar Parent" : "Crear Parent"}
                </h4>
