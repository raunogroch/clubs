...
export const ParentTooltip: React.FC<ParentTooltipProps> = React.memo(
  ({ parentId, children }) => {
  ...
  (prevProps, nextProps) => {
    // Only re-render if parentId changes
    return prevProps.parentId === nextProps.parentId;
  },
);

ParentTooltip.displayName = "ParentTooltip";
