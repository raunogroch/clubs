        ...
        <ul className="nav metismenu" id="side-menu">
          <li className="nav-header">
            <div className="dropdown profile-element">
              <Image
                src="/src/assets/img/profile_small.jpg"
                alt="image"
          ...
          <li>
            <a href="#">
              ...
              <span className="float-right label label-primary">SPECIAL</span>
            </a>
            <ul className="nav nav-second-level collapse">
              <li>
          ...
          <li>
            <a href="#">
              ...
              <span className="label label-info float-right">NEW</span>
            </a>
            <ul className="nav nav-second-level collapse">
              <li>
          ...
          <li>
            ...
            <ul className="nav nav-second-level collapse">
              ...
              <li>
                <a href="helper_classes.html">Helper css classNamees</a>
              </li>
              <li>
          ...
          <li>
            <a href="css_animation.html">
              ...
              <span className="label label-info float-right">62</span>
            </a>
          </li>
          <li className="landing_link">
            <a target="_blank" href="landing.html">
              ...
              <span className="label label-warning float-right">NEW</span>
            </a>
          </li>
