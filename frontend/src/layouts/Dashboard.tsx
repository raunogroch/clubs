          ...
          <div className="col-md-3">
            ...
            <ul className="list-group clear-list m-t">
              <li className="list-group-item fist-item">
                <span className="float-right">09:00 pm</span>
                <span className="label label-success">1</span> Please contact me
              </li>
              <li className="list-group-item">
                <span className="float-right">10:16 am</span>
                <span className="label label-info">2</span> Sign a contract
              </li>
              <li className="list-group-item">
                <span className="float-right">08:22 pm</span>
                <span className="label label-primary">3</span> Open new shop
              </li>
              <li className="list-group-item">
                <span className="float-right">11:06 pm</span>
                <span className="label label-default">4</span> Call back to
                Sylvia
              </li>
              <li className="list-group-item">
                <span className="float-right">12:00 am</span>
                <span className="label label-primary">5</span> Write a letter to
                Sandra
              </li>
            </ul>
          </div>
            ...
            <div className="row text-left">
              <div className="col">
                <div className=" m-l-md">
                  ...
                  <small className="text-muted m-b block">
                ...
                <div className="col-lg-4">
                  <div className="ibox ">
                    <div className="ibox-title">
                      ...
                      <span className="label label-primary">IN+</span>
                      ...
                      <ul className="list-group">
                        <li className="list-group-item">
                          <p>
                            ...
                            I belive that. Lorem Ipsum is simply dummy text of
                            the printing and typesetting industry.
                          </p>
                          <small className="block text-muted">
                            <i className="fa fa-clock-o"></i> 1 minuts ago
                          </small>
                        </li>
                        <li className="list-group-item">
                          <p>
                          ...
                          <div className="feed-element">
                            ...
                            <div className="media-body ">
                              ...
                              <div className="well">
                                ...
                                the 1500s. Over the years, sometimes by
                ...
                <div className="col-lg-4">
                  <div className="ibox ">
                    ...
                    <div className="ibox-content ibox-heading">
                      ...
                      <small>
                        <i className="fa fa-map-marker"></i> Meeting is on
                        6:00am. Check your schedule to see detail.
                      </small>
                    </div>
                      ...
                      <div className="timeline-item">
                        <div className="row">
                          ...
                          <div className="col content">
                            ...
                            <p>
                              Go to shop and find some products. Lorem Ipsum is
