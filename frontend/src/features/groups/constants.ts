...
export const MESSAGES = {
  ...
  INFO_MEMBER_ROLE_MISMATCH: 'El usuario encontrado es {{role}}, pero se busca un {{expectedRole}}',

  // Estados
  STATE_LOADING: 'Cargando grupos...',
  STATE_NO_GROUPS: 'No hay grupos creados en este club. Crea uno nuevo para comenzar.',
